...
namespace POSales
{
    public partial class ChangePassword : Form
    {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            if(txtPass.Text == "")
            {
                MessageBox.Show("Plesae fill all textboxes");
            }
            else
            {
                try
        ...
        {
            if (txtPass.Text == "" || txtNewPass.Text == "" || txtComPass.Text == "")
            {
                MessageBox.Show("Plesae fill all textboxes");
            }
            else
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            dbcon.ExecuteQuery("UPDATE Login set password = '" + txtNewPass.Text + "' WHERE username = '" + lblUsername.Text + "'");

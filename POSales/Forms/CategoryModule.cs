    ...
    public partial class CategoryModule : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        cn.Open();
                        cm = new SqlCommand("INSERT INTO tbCategory(category,registeredBy)VALUES(@category,@registeredBy)", cn);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    cn.Open();
                    cm = new SqlCommand("UPDATE tbCategory SET category = @category, registeredBy=@registeredBy WHERE id LIKE'" + lblId.Text + "'", cn);
                    cm.Parameters.AddWithValue("@category", txtCategory.Text);
                    cm.Parameters.AddWithValue("@registeredBy", int.Parse(user_id));
                    cm.ExecuteNonQuery();
                    cn.Close();
